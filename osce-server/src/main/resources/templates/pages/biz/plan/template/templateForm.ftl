                ...
                <form class="layui-form" lay-filter="step1FormFilter">
                    <div class="layui-form-item">
                        <div class="conatiner1">
                            <div class="header-table" style="padding-left: 5px; padding-right: 5px;background: #ffffff;">
                                <div class="layui-row form-item-my5">
                                    <span style="font-size: 16px; font-weight: 600; float: left;margin: 15px 0 0 15px;">OSCE管理</span>
                                    <span style="float: right;">
                                        ...
                                        <button id="previewStation" type="button" class="layui-btn layui-btn-normal" style="border-radius:4px; background-color: #5FB878; display: none;">排站预览</button>
