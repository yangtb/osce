layui.config({
    ...
    $('#addSheet').on('click', function () {
        ...
        common.openOffset('新增考评表', basePath + '/pf/p/plan/paper/sheet/page?idCase=' + idCase,
            350, 190, x, y + 35);
    });
    ...
    $('#delSheet').on('click', function () {
        ...
        var url = basePath + '/pf/r/plan/paper/sheet/del';
    ...
    var _delItem = function (currentData) {
        var url = basePath + '/pf/r/plan/paper/item/del';
        var reqData = new Array();
    ...
    form.on('switch(fgActiveCheckFilter)', function (obj) {
        ...
        $.ajax({
            url: basePath + '/pf/r/plan/paper/sheet/updateStatus',
            type: 'post',
            dataType: 'json',
...
var _setSheet = function () {
    layui.use(['jquery', 'form','common'],function(){
        ...
        layer.load(2);
        $.ajax({
            url: basePath + '/pf/r/plan/paper/sheet/list',
            type: 'post',
            dataType: 'json',
            contentType: "application/json",
            data: JSON.stringify(bizData),
