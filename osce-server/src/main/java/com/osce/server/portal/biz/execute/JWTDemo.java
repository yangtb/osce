...
public class JWTDemo {
    ...
    public String createTokenWithClaim() {
        ...
        try {
            ...
            String token = JWT.create()
                    ...
                    .withHeader(map)
                    /*设置 载荷 Payload*/
                    .withClaim("loginName", "yangtb")
                    .withClaim("idRoom", "201")
                    .withClaim("idOrg", "1")
                    .withIssuer("SERVICE")//签名是有谁生成 例如 服务器
                    .withSubject("this is test token")//签名的主题
                    //.withNotBefore(new Date())//定义在什么时间之前，该jwt都是不可用的.
    ...
    public void verifyToken(String token) {
        try {
            ...
            Claim claimidRoom = claims.get("idRoom");
            Claim claimidOrg = claims.get("idOrg");
            System.out.println(claim.asString());
            System.out.println(claimidRoom.asString());
            System.out.println(claimidOrg.asString());
