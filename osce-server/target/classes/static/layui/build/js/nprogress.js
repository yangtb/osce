    ...
    !function (e, t) {
        ...
        var l = function () {
            ...
            function e(n) {
                ...
                if (n in e) return n;
                for (var t, r = i.length, s = n.charAt(0).toUpperCase() + n.slice(1); r--;) if ((t = i[r] + s) in e) return t;
                return n
            }
            ...
            return function (n, e) {
                var t, i, s = arguments;
                if (2 == s.length) for (t in e) void 0 !== (i = e[t]) && e.hasOwnProperty(t) && r(n, t, i); else r(n, s[1], s[2])
            }
        }();
        return u
    }), layui.link("public/layui/build/css/nprogress.css"), n("nprogress")
});