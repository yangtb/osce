    ...
    Class.prototype={
        ...
        rightClickMenu: function() {
            ...
            var menuStr=['<ul id="tree-menu" lay-filter="treeMenu">'
                ...
                ,$.inArray("add",this.contextmenuList)!==-1?'<li class="add"><a href="javascript:;"> <i class="layui-icon layui-icon-add-1"></i>新增</a></li>':''
                ,$.inArray("edit",this.contextmenuList)!==-1?'<li class="edit"><a href="javascript:;"><i class="layui-icon layui-icon-edit"></i>修改</a></li>':''
                ,$.inArray("remove",this.contextmenuList)!==-1?'<li class="remove"><a href="javascript:;"><i class="layui-icon layui-icon-delete"></i>删除</a></li>':''
            ,'</ul>'].join("");
            ...
            $(this.elem).on("contextmenu",".eleTree-node-content",function(e) {
                ...
                $("#tree-menu li.add").off().on("click",function() {
                    layer.prompt({title: "请输入节点值", offset: 'l'},function(value, index, elem){
